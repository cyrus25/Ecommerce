...
module.exports.productUpdate=function(req,res){
 ...
 form.parse(req,(err,fields,files)=>{
   ...
   // console.log(fields);
     ...
     let product=req.product;//name email
 ...
 module.exports.list=function(req,res){
  ...
  //if no params then all products returned
...
//it will the products based on product category
 module.exports.listRelated=function(req,res){
